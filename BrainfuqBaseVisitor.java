...
/**
 * This class provides an empty implementation of {@link BrainfuqVisitor},
 ...
 */
public class BrainfuqBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements BrainfuqVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
