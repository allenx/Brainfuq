...
- Use the convenient scripts to run our interpreter: `brainfuck` to interpret a brainfuck file, and `brainfucki` to enter the magnificent Brainfuck REPL.
...
We do it by character replacing (I know. It's easy).
